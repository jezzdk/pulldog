...
type Variant = 'default' | 'secondary' | 'destructive' | 'outline' | 'success' | 'warning' | 'purple'
...
const base = 'inline-flex items-center gap-1 rounded-full border font-mono text-[10px] font-medium px-2 py-0.5 transition-colors'
