    ...
    <table class="w-full border-collapse text-xs">
      <thead>
        <tr class="border-b border-border bg-muted/30">
          ...
          <th class="text-left font-mono text-[10px] uppercase tracking-widest text-muted-foreground px-3 py-2 w-32 hidden sm:table-cell">Author</th>
      ...
      <tbody>
        ...
        >
          ...
          <td class="px-3 py-2.5 hidden sm:table-cell">
            ...
            >
              <Avatar :src="pr.author.avatar_url + '&s=48'" :alt="pr.author.login" />
              <span class="font-mono text-[11px] text-muted-foreground group-hover:text-primary transition-colors">
                {{ pr.author.login }}
              </span>
            </a>
          </td>
          ...
          <td class="px-3 py-2.5 hidden sm:table-cell">
            <div
              ...
              :class="pr.commentCount >= commentFireThreshold
                ? 'text-orange-400 font-semibold'
                : 'text-muted-foreground'"
            >
              <span>{{ pr.commentCount }}</span>
              <span v-if="pr.commentCount >= commentFireThreshold" class="text-sm leading-none" title="Hot PR!">🔥</span>
            </div>
          </td>
